...
For our examples, we have assumed a binomial likelihood with a beta prior (this is a [conjugate prior](https://en.wikipedia.org/wiki/Conjugate_prior))  $$\begin{align}
X|\theta &\sim Binomial(n, \; \theta) \\
\theta &\sim Beta(\alpha, \; \beta)
\end{align}$$ Then $$\begin{align}
p( \theta \; | \; x) &= 
